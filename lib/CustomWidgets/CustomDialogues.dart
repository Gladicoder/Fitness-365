                      ...
                      ? Expanded(
                          child: ElevatedButton(
                            ...
                            child: customTextWidget.boldText(
                                text: btnText2, size: 14, color: BLACK),
                          ),
                        )
                      : Container(),
                ],
                ...
                children: [
                  btnText1 != null
                      ? Expanded(
                          ...
                          child: customTextWidget.boldText(
                              text: btnText1, size: 14, color: WHITE),
                        ))
                      : Container(),
                ],
              )
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          customTextWidget.mediumText(
                              text: title, size: 15, color: BLACK),
                          SizedBox(
                            width: 30,
                          )
                        ],
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          customTextWidget.mediumText(
                              text: "Loading..", size: 15, color: BLACK),
                          SizedBox(
                            width: 30,
                          )
                        ],
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              t.regularText(text: msg, size: 15, alignment: TextAlign.center),
              SizedBox(
                height: 20,
              ),
              btnYesText == null
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: t.mediumText(
                                      text: btnYesText, color: WHITE, size: 15),
                                ),
                              ),
                            ),
                          ),
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: t.mediumText(
                                      text: btnNoText, color: BLACK, size: 15),
                                ),
                              ),
                            ),
                          ),
