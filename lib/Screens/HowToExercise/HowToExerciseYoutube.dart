...
class HowToExerciseYoutube extends StatefulWidget {
  ...
  HowToExerciseYoutube({@required this.ex_id});
...
class _HowToExerciseYoutubeState extends State<HowToExerciseYoutube> {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child:customTextWidget.boldText(text: HOW_TO_EXERCISE,size: 33,color: BLACK),
                          ),
                        ),
                        SizedBox(height: 15,),
                        Container(
  ...
  getExercisesSteps() async{
    final _response=await http.get(Uri.parse(SERVER_ADDRESS+"/api/get_exercise_step_list.php?ex_id="+widget.ex_id));
    final _jsonResponse=jsonDecode(_response.body);
    print("HowToExercise/"+SERVER_ADDRESS+"/api/get_exercise_step_list.php?ex_id="+widget.ex_id);
        ...
        child: Row(
          children: [
            Row(
              ...
              children: [
                SizedBox(width: 15,),
                customTextWidget.boldText(text: index < 9 ? "0"+(index+1).toString() : "${index + 1}",size: 25,color: BLACK),
                SizedBox(width: 15,),
              ],
            ),
            Expanded(
              child: Container(
                ...
                child: Padding(
                  ...
                  child: customTextWidget.mediumText(text:list[index].step,size: 12,color: DARK_GREY_TEXT),
                ),
              ),
            )
          ],
        ...
        children: [
          Row(
            ...
            children: [
              ...
              SizedBox(width: 15,),
              VerticalDivider(width: 1,color: LIGHT_GREY_TEXT,),
              SizedBox(width: 15,)
            ],
          ),
          Expanded(
