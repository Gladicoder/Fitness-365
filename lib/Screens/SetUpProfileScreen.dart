...
class _SetUpProfileScreenState extends State<SetUpProfileScreen> {
  ...
  List<IntenseCardModel> intenselyList = [
    ...
    IntenseCardModel(MODERATE[LANGUAGE_TYPE], MODERATE_EXPLANATION[LANGUAGE_TYPE]),
    IntenseCardModel(HIGH[LANGUAGE_TYPE], HIGH_EXPLANATION[LANGUAGE_TYPE]),
  ];
  List<IntenseCardModel> timesInWeekList = [
    IntenseCardModel(TWO_THREE_TIMES_IN_WEEK[LANGUAGE_TYPE], TWO_THREE_TIMES_IN_WEEK_EXPLANATION[LANGUAGE_TYPE]),
    IntenseCardModel(FIVE_DAYS_IN_WEEK[LANGUAGE_TYPE], FIVE_DAYS_IN_WEEK_EXPLANATION[LANGUAGE_TYPE]),
    IntenseCardModel(ALL_SEVEN_DAYS[LANGUAGE_TYPE], ALL_SEVEN_DAYS_EXPLANATION[LANGUAGE_TYPE]),
  ];
  double WIDTH;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 30,),
              customTextWidget.boldText(
                  text: HOW_INTENSIVELY_YOU_WORKOUT,
                  color: BLACK,
                  size: 25
              ),
              SizedBox(height: 16,),
              ...
              Column(
                ...
                children: List.generate(intenselyList.length, (index) => intenseLevelCard(title: intenselyList[index].title, subTitle: intenselyList[index].subTitle, index: index)),
              )
  ...
  intenseLevelCard({String title, String subTitle, int index}) => InkWell(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        border: selectedIntenseLevel != index ? Border.all(width: 2, color: BLUE) : Border.all(color: Colors.transparent)
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          customTextWidget.mediumText(
              text: subTitle,
              color: selectedIntenseLevel == index ? WHITE : LIGHT_GREY_TEXT,
              size: 12
          ),
        ],
      ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          SizedBox(height: 30,),
          customTextWidget.boldText(
              text: WHATS_YOUR_GENDER,
              color: BLACK,
              size: 25
          ),
          SizedBox(height: 16,),
          customTextWidget.mediumText(
              text: GENDER_EXPLANATION,
              color: LIGHT_GREY_TEXT,
              size: 12
          ),
          SizedBox(height: 40,),
          ...
          Row(
            children: [
              ...
              Expanded(flex: 5, child: genderCard(index: 0, name: MALE[LANGUAGE_TYPE], imagePath: "assets/splash/male@3x.png"),),
              Expanded(flex: 2, child: SizedBox(),),
              Expanded(flex: 5, child: genderCard(index: 1, name: FEMALE[LANGUAGE_TYPE], imagePath: "assets/splash/female@3x.png"),),
              Expanded(flex: 2, child: SizedBox(),),
            ],
          )
      ...
      child: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(15),
              color: selectedGender == index ? ORANGE.withOpacity(0.6) : WHITE,
              border: selectedGender != index ? Border.all(color: ORANGE) : Border.all(color: Colors.transparent),
            ),
            child: Padding(
                      ...
                      Center(
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: (currentAgeScroller % currentAgeScroller.toInt()) == 0 ? BLUE : Colors.transparent,// BLUE,
                            ),
                            child: Center(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          SizedBox(height: 30,),
          customTextWidget.boldText(
              text: WHAT_IS_YOUR_HEIGHT,
              color: BLACK,
              size: 25
          ),
          SizedBox(height: 16,),
          customTextWidget.mediumText(
              text: HEIGHT_EXPLANATION,
              color: LIGHT_GREY_TEXT,
              size: 12
          ),
                      ...
                      Center(
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              border: Border.all(color: BLUE),
                              color: (currentHeightScroller % currentHeightScroller.toInt()) == 0 ? BLUE : Colors.transparent,// BLUE,
                            ),
                            child: Stack(
                              children: [
                                Center(
  ...
  double indexToSize6(int index){
    if(index == currentHeight){
      ...
      return currentHeight - index < 5 ? 30 - (currentHeight - index) * 4.0  : 0.0;
    }else if(index > currentHeight){
      return index - currentHeight < 5 ? 30 - (index - currentHeight) * 4.0  : 0.0;
    }else{
      return 10;
    }
  }
  ...
  double indexToOpacity6(int index){
    if(index == currentHeight){
      ...
      return currentHeight - index < 5 ? 1.0 - ((currentHeight - index) / 5)  : 0.0;
    }else if(index > currentHeight){
      return index - currentHeight < 5 ? 1.0 - ((index - currentHeight) / 5)  : 0.0;
    }else{
      return 10;
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisSize: MainAxisSize.min,
              children: List.generate(timesInWeekList.length, (index) => timesInWeekCard(title: timesInWeekList[index].title, subTitle: timesInWeekList[index].subTitle, index: index)),
            )
  ...
  timesInWeekCard({String title, String subTitle, int index}) => InkWell(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
          ...
          border: selectedTimesInWeek != index ? Border.all(width: 2, color: BLUE) : Border.all(color: Colors.transparent)
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        mainAxisSize: MainAxisSize.min,
  ...
  registerUser() async{
    customDialogues.progressDialog(context: context, title: SAVING_INFO[LANGUAGE_TYPE]);
    var request = http.MultipartRequest('POST', Uri.parse('$SERVER_ADDRESS/api/user_register.php'));
