              ...
              Row(
                ...
                children: [
                  InkWell(
                      onTap: () async{
                        pauseOrPlay(false);
                        await Navigator.push(context, MaterialPageRoute(builder: (context) => PLAY_YOUTUBE_VIDEOS ? HowToExerciseYoutube(ex_id: list[currentIndex].id) : HowToExerciseMp4(ex_id: list[currentIndex].id)));
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: resumeTime == 0
                              ...
                              children: [
                                t.mediumText(
                                    text : int.parse(list[currentIndex].timee) > 60
                                        ? "00:00"
          ...
          rotationController.addListener(() {
            ...
            if (rotationController.isAnimating) {
              ...
              if (previousCompletedExerciseTime < completedExerciseTime ||
                ...
                if(int.parse(list[currentIndex].timee)~/2 == completedExerciseTime){
            ...
            if (isPlaying && value > 0.0) {
              if(mounted) {
                setState(() {
                  ...
                  completedExerciseTime =
                      (value * double.parse(list[currentIndex].timee))
                          .toInt();
                  print("completedExerciseTime = ${(value * double.parse(
                      list[currentIndex].timee)).toInt()}");
                });
                rotationController.forward();
              }
            } else if (isPlaying) {
