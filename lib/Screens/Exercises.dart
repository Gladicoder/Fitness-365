...
class ExercisesScreen extends StatefulWidget {
  ...
  ExercisesScreen({@required this.category_id,@required this.category_name, @required this.category_description,
      @required this.total_exercise, @required this.total_time, @required this.total_calories, @required this.image_url});
...
class _ExercisesScreenState extends State<ExercisesScreen> {
 ...
 void handleClick(String value) {
                            ...
                            Container(
                              ...
                              child: CachedNetworkImage(
                                ...
                                width: MediaQuery
                                    ...
                                    .size
                                    .width,
                                imageUrl: IMAGE_ADDRESS_HOME+widget.image_url??" ",
  ...
  getExercisesbyCategoryList() async{
    final _response=await http.post(Uri.parse(SERVER_ADDRESS+"/api/getexercisebycategory.php?cat_id="+widget.category_id));
    final _jsonResponse=jsonDecode(_response.body);
    print("ExercisesScreen/"+SERVER_ADDRESS+"/api/getexercisebycategory.php?cat_id="+widget.category_id);
              ...
              child: Row(
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> PLAY_YOUTUBE_VIDEOS ? HowToExerciseYoutube(ex_id: list[index].id,) : HowToExerciseMp4(ex_id: list[index].id,)));
                      },
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            child:ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                height: HEIGHT * 0.20,
                                width: WIDTH * 0.20,
                                imageUrl: IMAGE_URL_MENU_ITEM+list[index].image??" ",
                                progressIndicatorBuilder: (context, url,
                                    downloadProgress) =>
                                    Container(),
                                errorWidget: (context, url, error) =>
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  customTextWidget.mediumText(text: list[index].name,size: 18,color: BLACK,textOverFlow: TextOverflow.ellipsis),
                                  SizedBox(height: 8),
                                  customTextWidget.mediumText(text:"X "+list[index].repeatCount.toString()??" ",color: LIGHT_GREY_TEXT,size: 14),
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> PLAY_YOUTUBE_VIDEOS ? HowToExerciseYoutube(ex_id: exercisesClass.data.exercise.create[index].id) : HowToExerciseMp4(ex_id: exercisesClass.data.exercise.create[index].id)));
                    },
                    child: Container(
                      height: 70,
                      child:Padding(
