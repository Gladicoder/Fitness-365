...
class _SelectWorkoutsState extends State<SelectWorkouts> {
    ...
    return SafeArea(child: Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            customTextWidget.boldText(text: SELECT_WORKOUT,size: 33,color: BLACK),
            SizedBox(height: 5),
            // customTextWidget.regularText(text: SELECT_ANY_THREE,size: 15,color: DARK_GREY_TEXT),
            // SizedBox(height: 5),
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: isChipSelected[index]==false?LIGHT_GREY_TEXT:BLUE,
                                          ...
                                          child: Padding(
                                            ...
                                            child:Padding(
                                              ...
                                              child: Container(
                                                ...
                                                width: 16,
                                                decoration: BoxDecoration(
                                                    color: isChipSelected[index]==false?WHITE:BLUE,
                                                    borderRadius: BorderRadius.circular(8)
                                                ),),
                                            ),
                                            ),
                                        ...
                                        Container(
                                          ...
                                          ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              height: 70,
                                              width:70,
                                              imageUrl: IMAGE_URL_MENU_ITEM+workoutslist[index].image??" ",
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Expanded(child:
                                                customTextWidget.mediumText(text:workoutslist[index].name??" ",size: 16,color: BLACK),

                                                ),
                                                SizedBox(height: 0,),
                                                customTextWidget.mediumText(text:"X "+ workoutslist[index].repeatCount,size: 16,color: DARK_GREY_TEXT),
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=> PLAY_YOUTUBE_VIDEOS ? HowToExerciseYoutube(ex_id: workoutslist[index].id,) : HowToExerciseMp4(ex_id: workoutslist[index].id,)));
              ...
              onTap: (){
                ...
                for(int i=0;i<workoutslist.length;i++){
                  ...
                  if(isChipSelected[i]==true){
                    mylist.add(CustomWorkoutCreateClass(name: workoutslist[i].name,calories: workoutslist[i].calories,catName: workoutslist[i].catName,createdAt: workoutslist[i].createdAt,datetime: workoutslist[i].datetime,deletedAt: workoutslist[i].deletedAt,gif: workoutslist[i].gif,id: workoutslist[i].id,image: workoutslist[i].image,isDeleted: workoutslist[i].isDeleted,repeatCount: workoutslist[i].repeatCount,timee: workoutslist[i].timee,updatedAt: workoutslist[i].updatedAt,url: workoutslist[i].url));
                  }
                }
                if(mylist.isNotEmpty){
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>SelectExercise(mylist,ttltime.toString(),ttlcalories.toString()))).whenComplete((){
                  ...
                  showCustomDialog(
                      context: context,
                      title: ERROR,
                      msg: "Select at least one workout",
                      btnYesText: OK,
                      onPressedBtnYes: (){
                        Navigator.pop(context);
                      }
  ...
  getExercisesList() async{
    final _response=await http.post(Uri.parse(SERVER_ADDRESS+"/api/get_allexcercise.php"));
    final _jsonResponse=jsonDecode(_response.body);

    if(_response.statusCode==200 && _jsonResponse['data']['success']=="1"){
      allWorkoutsClass=AllWorkoutsClass.fromJson(_jsonResponse) ;
      print("SelectWorkoutScreen/"+SERVER_ADDRESS+"/api/get_allexcercise.php");
