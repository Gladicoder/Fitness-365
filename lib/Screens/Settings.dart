        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // account section
              // ACCOUNT SETTING REMOVE TEMPORARY
              ...
              customTextWidget.boldText(
                  text: NOTIFICATION, size: 17, color: BLUE),
              SizedBox(height: 15),
              lt.tile(
                icon: "reminder",
                ...
                widget: GestureDetector(
                    ...
                    child: isReminderOn
                        ? Image.asset(
                            "assets/setting/switch_active.png",
                            height: 25,
                            width: 35,
                          )
                        : Image.asset(
                            "assets/setting/switch.png",
                            height: 25,
                            width: 35,
                          )),
              ),
              ...
              // volume section
              customTextWidget.boldText(
                  text: APP_VOLUME, size: 17, color: BLUE),
              SizedBox(
                height: 15,
              ),
              Row(
             ...
             // ),
              ...
              // PRIVACY POLICY AND ABOUT SETTING REMOVE TEMPORARY
              // InkWell(
              //   onTap: () {
              //     Navigator.push(
              //         context,
