...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((event) {
      notificationHelper.showNotification(title: event.notification.title,body:event.notification.body ,payload: "payload", id: "124", context2: context);
    });
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              customTextWidget.regularText(text: FIND_YOUR,size: 20,color: DARK_BLUE),
              Row(
                children: [
                  customTextWidget.boldText(text: FAVOURITE_WORKOUT_PLAN,size: 25,color: DARK_BLUE),
                  Spacer(),
                  Image.asset("assets/icon.png",scale: 7)
                ],
              ),
  ...
  myFavouriteExerciseCard(int index,Animation animation) {
    return SizeTransition(
      ...
      child: InkWell(
        ...
        onTap: (){
          Navigator.push(context,MaterialPageRoute(builder: (context)=>ExercisesScreen(category_id:list[index].id,category_name: list[index].name,category_description: list[index].description, total_exercise: list[index].totalExercise, total_time: (list[index].time/60).toStringAsFixed(2), total_calories: list[index].calories.toString(),image_url: list[index].image,)));
        },
        child: Container(
          ...
          child: Stack(
            children: [
              ...
              Column(
                crossAxisAlignment:  CrossAxisAlignment.start,
                children: [
                  customTextWidget.mediumText(text:list[index].name??"7M Beginner",size: 20,color: WHITE),
                  SizedBox(height: 15,),
                  Row(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 3,),
                              customTextWidget.lightText(text:list[index].totalExercise+" "+EXERCISES[LANGUAGE_TYPE]??" ",size: 12,color: WHITE)
                            ],
                          ),
                          SizedBox(height: 8,),
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 3,),
                              customTextWidget.lightText(text:list[index].calories.toString()+" "+CALORIES_SMALL[LANGUAGE_TYPE]??" ",size: 12,color: WHITE)
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 3),
                              customTextWidget.lightText(text:(list[index].time/60).toStringAsFixed(2)+ " "+MINUTES_SMALL[LANGUAGE_TYPE]?? " ",size: 12,color: WHITE)
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 3,),
                              customTextWidget.lightText(text:list[index].level?? " ",size: 12,color: WHITE)
  ...
  getExercisesList() async{
    final _response = await http.get(Uri.parse(SERVER_ADDRESS+"/api/get_set_by_category.php"))
    .catchError((e){
      showCustomDialog(
          context: context,
          title: ERROR,
